...
// 2. Join the room when activeChannel changes
    useEffect(() => {
    ...
    function getOtherUser(chat) {
        return Array.isArray(chat.users)
            ? chat.users.find((n) => n !== username) || "Unknown"
            : "Unknown";
    }
                    ...
                    >
                        <form onSubmit={handleCreateChat}>
                            ...
                            <div>
                                ...
                                <button type="button" onClick={() => chatForm.current.style.display = "none"}>Cancel</button>
                            </div>
                        </form>
                    </div>
                    {/* Chat Messages */}
                    ...
                    <div className="message-form">
                        <form onSubmit={sendMessage} style={{ display: "flex" }}>
                            <input
                                ...
                                style={{ flex: 1, marginRight: 10, borderRadius: 8, border: "1px solid #ccc", padding: 8 }}
                            />
